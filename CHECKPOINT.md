...
- TASK-001…TASK-007 слиты в `main` отдельными merge-коммитами.
- TASK-008 завершена в короткоживущей ветке
  `task/008-single-snapshot-normalization`; факт интеграции в `main` следует
  подтверждать через Git после завершения текущей сессии.
