...
На этапе TASK-001 создаётся только переносимый документальный фундамент и Git-история проекта.

В текущий объём не входят выбор технологического стека, программный код, база данных, API, интерфейс, парсеры конкретных площадок, Docker, ИИ, OpenClaw, Telegram и публикация удалённого репозитория. Соблюдение правовых требований, условий площадок, ограничений на сбор и хранение данных будет конкретизировано до реализации источников.
