...
- **TASK-007 — фиктивный source adapter.** Адаптировать проверенный пакет через контракт фиктивного источника, проверить source, publication id и URL без нормализации. Рекомендуемая следующая задача.
