...
- **TASK-004 — стратегия проверок и фикстур.** Определить уровни тестирования, эталонные данные и критерии воспроизводимости без обращения к реальным площадкам. Это рекомендуемая следующая задача; в TASK-003 она не выполняется.
