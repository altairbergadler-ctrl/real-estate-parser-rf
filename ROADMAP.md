...
- **TASK-002 — технологический стек и минимальный сквозной срез.** Сравнить варианты по требованиям проекта, выбрать минимально достаточный стек и описать один сквозной сценарий от тестового входа до результата поиска. Это рекомендуемая следующая задача; в TASK-001 она не выполняется.
- **TASK-003 — предметная модель и границы контрактов.** Спроектировать минимальные сущности, происхождение данных, состояния неопределённости и контракты между модулями для выбранного среза.
