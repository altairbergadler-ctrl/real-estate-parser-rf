...
- **TASK-005 — программный каркас и команды качества.** Создать только минимальный `src`-layout, зафиксировать зависимости и одну воспроизводимую команду Ruff/mypy/pytest/fixture checks. Это рекомендуемая следующая задача; предметный поток в неё не входит.
