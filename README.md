...
Сейчас в репозитории находится документальный фундамент и проект первого локального сквозного среза. Для будущей реализации выбран минимальный Python-стек, но программного кода, базы данных, API, интерфейса, парсеров площадок, ИИ и интеграций ещё нет.
